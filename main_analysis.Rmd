...
for(i in 1:nrow(ecoli_rare_double)){
  print(i)
  ecoli_rare_double$b1[i] <- quantile(as.numeric(ecoli_rare_double[i, 2:101]), probs = c(0.025))
  ecoli_rare_double$b2[i] <- quantile(as.numeric(ecoli_rare_double[i, 2:101]), probs = c(0.975))
  
  ecoli_rare_single$b1[i] <- quantile(as.numeric(ecoli_rare_single[i, 2:101]), probs = c(0.025))
  ecoli_rare_single$b2[i] <- quantile(as.numeric(ecoli_rare_single[i, 2:101]), probs = c(0.975))
  
  ecoli_rare_tenner$b1[i] <- quantile(as.numeric(ecoli_rare_tenner[i, 2:101]), probs = c(0.025))
  ecoli_rare_tenner$b2[i] <- quantile(as.numeric(ecoli_rare_tenner[i, 2:101]), probs = c(0.975))
}
ecoli_rare_double$isolate<-NA
ecoli_rare_double$catalogue<-"Double_Rarefaction"
ecoli_rare_double$n<-NA
